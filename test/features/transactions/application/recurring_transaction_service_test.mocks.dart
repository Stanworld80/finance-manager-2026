...
// in finance_manager_2026/test/features/transactions/application/recurring_transaction_service_test.dart.
...
class MockRecurringTransactionRepository extends _i1.Mock
    implements _i5.RecurringTransactionRepository {
  MockRecurringTransactionRepository() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i6.Future<void> createRecurringTransaction(
    String? userId,
    _i7.RecurringTransaction? transaction,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> updateRecurringTransaction(
    String? userId,
    _i7.RecurringTransaction? transaction,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> deleteRecurringTransaction(
    String? userId,
    String? transactionId,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#deleteRecurringTransaction, [
              userId,
              transactionId,
            ]),
            returnValue: _i6.Future<void>.value(),
  ...
  @override
  _i6.Stream<List<_i7.RecurringTransaction>> watchRecurringTransactions(
    String? userId,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#watchRecurringTransactions, [userId]),
            returnValue: _i6.Stream<List<_i7.RecurringTransaction>>.empty(),
          )
          as _i6.Stream<List<_i7.RecurringTransaction>>);

  @override
  _i6.Future<List<_i7.RecurringTransaction>> getRecurringTransactions(
    String? userId,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#getRecurringTransactions, [userId]),
            returnValue: _i6.Future<List<_i7.RecurringTransaction>>.value(
              <_i7.RecurringTransaction>[],
            ),
          )
          as _i6.Future<List<_i7.RecurringTransaction>>);
}
