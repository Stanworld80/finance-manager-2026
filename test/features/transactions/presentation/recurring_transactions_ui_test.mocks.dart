...
// in finance_manager_2026/test/features/transactions/presentation/recurring_transactions_ui_test.dart.
...
class MockRecurringTransactionService extends _i1.Mock
    implements _i6.RecurringTransactionService {
  ...
  _i7.Future<void> addRecurringTransaction({
    required _i8.RecurrenceFrequency? frequency,
    int? interval = 1,
  ...
  @override
  _i7.Future<void> deleteRecurringTransaction(String? id) =>
      (super.noSuchMethod(
  ...
  @override
  _i7.Future<List<_i9.TransactionModel>> generateOccurrences(
    DateTime? untilDate,
  ) =>
      (super.noSuchMethod(
            Invocation.method(#generateOccurrences, [untilDate]),
            returnValue: _i7.Future<List<_i9.TransactionModel>>.value(
              <_i9.TransactionModel>[],
            ),
          )
